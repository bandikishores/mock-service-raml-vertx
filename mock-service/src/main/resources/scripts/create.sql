...
CREATE TABLE RESPONSE_DATA(ID INT primary key auto_increment, 
						RESPONSE_CONTENT_TYPE VARCHAR(255),
						STATUS_CODE INT,
						URI VARCHAR_IGNORECASE(255) NOT NULL, 
...
ALTER TABLE RESPONSE_DATA ADD UNIQUE INDEX(URI, ACTION_TYPE);
